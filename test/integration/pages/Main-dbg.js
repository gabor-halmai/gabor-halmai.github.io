sap.ui.require([
  ...
  var sViewName = "com.otisoft.favs.Favorites.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "com.otisoft.favs.Favorites"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title com.otisoft.favs.Favorites"
            });
        }
      }
